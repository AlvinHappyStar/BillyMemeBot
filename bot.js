...
bot.on('message', (msg) => {
    ...
    if (messageText.localeCompare(start) == 0) {
        console.log("start");
        count = 1;
        bot.sendMessage(msg.chat.id, "Let's make a meme! Choose from the following /billywait");
        ...
        // Delay for 1 seconds
        setTimeout(() => {
            bot.sendMessage(msg.chat.id, "When you’re ready to generate another meme use /start to get started!");
        }, 1000)
